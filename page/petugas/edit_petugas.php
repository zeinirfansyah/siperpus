...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="nama_petugas" name="nama_petugas" value="<?=$nama_petugas ?>" type="text" placeholder="Masukan nama petugas" required/>
    </div>
    <div class="form-group">
        <label class="small mb-1" for="alamat_petugas">Ubah Alamat</label>
        <input class="form-control" id="alamat_petugas" value="<?= $alamat_petugas; ?>" name="alamat_petugas" type="text" placeholder="Masukan alamat petugas" required/>
    </div>
    <div class="form-group">
        <label class="small mb-1" for="no_hp_petugas">Ubah Nomor Handphone</label>
        <input class="form-control" id="no_hp_petugas" value="<?= $no_hp_petugas; ?>" name="no_hp_petugas" type="text" placeholder="Masukan alamat petugas" required/>
    </div>
    <div class="form-group">
        <label class="small mb-1" for="email_petugas">Ubah Email</label>
        <input class="form-control" id="email_petugas" value="<?= $email_petugas; ?>" name="email_petugas" type="email" placeholder="Masukan email petugas" required/>
    </div>
    <div class="form-group">
